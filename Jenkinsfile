pipeline {
  ...
  post {
    always {
      emailext body: 'Test jenkins email body', subject: 'Test jenkins email subject', recipientProviders: [[$class: 'DevelopersRecipientProvider'], [$class: 'RequesterRecipientProvider']]
    }
  }
}
