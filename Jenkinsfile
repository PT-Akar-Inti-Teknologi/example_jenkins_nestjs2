pipeline {
  ...
  post {
    always {
      emailext body: 'Test jenkins email', subject: 'Test jenkins email subject', recipientProviders: [[$class: 'DevelopersRecipientProvider'], [$class: 'RequesterRecipientProvider']]
    }
  }
}
